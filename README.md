...
### Note: Please skip to the end for specific details of this branch!
...
### Notes regarding this specific branch.

Using this, Whycon can be used as an API. src/main/runner.cpp provides an example of how the code can be used. 
Usage: 
```
cmake .
make
./whycon <numbots> <circlediameter>
```